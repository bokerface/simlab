<ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed active" href="#" data-toggle="collapse" data-target="#submenu-praktikum"
            aria-expanded="true" aria-controls="submenu-praktikum">
            <i class="far fa-fw fa-window-maximize"></i>
            <span>Praktikum</span>
        </a>
        <div id="submenu-praktikum"
    ...
    <li class="nav-item">
        ...
        <div id="softskill_menu"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item {{Request::is('mahasiswa')?'active':''}}" href="{{ url('/mahasiswa') }}">
                    Mahasiswa
                </a>
            </div>
        </div>
    ...
    <li class="nav-item {{Request::is('kurikulum/buat-kurikulum-baru')?'active':''}}">
        <a class="nav-link" href="{{ url('kurikulum/buat-kurikulum-baru') }}">
            <i class="fas fa-fw fa-chart-area"></i>
            <span>Buat Kurikulum Softskill</span>
        </a>
    </li>
    <hr class="sidebar-divider">
    <div class="sidebar-heading">
    ...
    <li class="nav-item">
        <a class="nav-link {{Request::is('pembayaran-dosen')?'active':''}}" href="{{ url('/pembayaran-dosen') }}">
            <i class="fas fa-fw fa-chart-area"></i>
    ...
    <li class="nav-item {{Request::is('daftar-dosen')?'active':''}}">
        <a class="nav-link" href="{{ url('/daftar-dosen') }}">
