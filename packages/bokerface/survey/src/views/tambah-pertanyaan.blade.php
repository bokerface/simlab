<x-components::layouts>
    ...
    <div class="mb-3">
        <div class="card">
            <div class="card-body">
                <form
                    action="{{ url('survey/edit'.'/'.$id_survey.'/tambah-pertanyaan') }}"
                    ...
                    <div class="form-group">
                        <div class="row mx-1">
                            ...
                            <div class="col-9">
                                <select
                                    class="form-control {{ $errors->has('question_type')?'is-invalid':'' }}"
                                    ...
                                    @foreach($daftar_jenis_pertanyaan as $jenis_pertanyaan)
                                        <option value="{{ $jenis_pertanyaan->question_type_id }}"
                                            {{ old('question_type') == $jenis_pertanyaan->question_type_id ? 'selected' : '' }}>
                    ...
                    <div class="form-group">
                        <div class="row mx-1">
                            ...
                            <div class="col-9">
                                <textarea
                                    class="form-control {{ $errors->has('jawaban')?'is-invalid':'' }}"
                                    name="jawaban" id="variant"
                                    rows="3">{{ old('jawaban') }}</textarea>
                                <div class="invalid-feedback">
